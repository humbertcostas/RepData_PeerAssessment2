...
## Human impact
Los tornados son los eventos que más daño humano provocan con diferencia.
...
Los tornados son los eventos que más costes economicos provocan, seguidos de cerca por los thunderstorm wind y las flood.
```{r cache=TRUE, echo=FALSE}
