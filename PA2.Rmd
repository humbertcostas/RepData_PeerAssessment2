...
La clasificación de los eventos metereologicos no parece seguir una clasificación muy cuidada. Se trata de `r length(levels(rawdata$EVTYPE))` tipos distintos de eventos, por ejemplo, veamos los 20 primeros: 
...
head(human_damages[order(-human_damages$FATALITIES, -human_damages$INJURIES), ], 10)
```
